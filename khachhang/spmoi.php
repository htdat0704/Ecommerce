...
<body>
        ...
        if (isset($_POST['ok'])) 
        {
            ...
            else
            {
                ...
                $query = " SELECT * FROM sanpham where tensp like '%$search%' ORDER BY id DESC";
...
<div class="phanba">
	<div class="container-fluid">
		<div class="row">	
            ...
            if($from<0) $from=0;
            $qr = "SELECT * FROM sanpham ORDER BY id DESC LIMIT $from, $sotin1trang ";
			...
			<nav aria-label="Page navigation example">
             <ul class="pagination">
				...
				for($t=1; $t<=$sotrang; $t++){	
					...
					?>
					<li class="page-item active"><a class="page-link" href="spmoi.php?trang=<?php echo $t ?>"><?php echo $t ?></a></li>
   					<?php
					}
					else
					{
						?>
						<li class="page-item "><a class="page-link" href="spmoi.php?trang=<?php echo $t ?>"><?php echo $t ?></a></li>
						<?php
					}
					}
					?>
