...
<body>
 ...
 <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
          	<br>
              <div class="text-center"><h1>Cập nhập ảnh</h1></div>
            <br>
          	<div class="container">
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
            <label class="control-label col-sm-2" >Tải ảnh mới:</label>
            <div class="col-sm-7">
            <input  type="file" class="form-control" name="filename" value=""><br><input  name="submit" type="submit" value="Thay đổi">      
            </div>
            </div>
            </form>
        </div>
<?php
	...
	if (isset($_POST['submit'])){	
		...
		if(($duoi=='jpg')||($duoi=='png')||($duoi=='jpeg')||($duoi=='gif'))
		{
			...
			echo '<br><div class="text-center"><a href="qlsp.php" class="templatemo-edit-btn">Tiếp tục</a></div><br>';
		}
		else{
