      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            ...
            <br>
            <br>
              <div class="text-center"><h1>Danh sách Danh mục </h1></div>
              <br>
              <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>
                  ...
                  if($from<0) $from=0;
                  $qr = "SELECT * FROM danhmuc LIMIT $from, $sotin1trang";
                      ...
                      while ($rownuoc=mysqli_fetch_array($ds))
                      {
                        ...
                        while ($rowkh=mysqli_fetch_array($conkh)){
                          ...
                          echo"<tr>";
                           ...
                           echo'<td class="text-center">' . $rownuoc["tendm"] .'</td>';
                             echo'<td class="text-center">' . $abc.'</td>';
                              echo'<td class="text-center"><a href="deletedm.php?id='.$rownuoc['id'].'" class="templatemo-edit-btn">Delete</a></td>';
                            echo"</tr>";
                    }
            ...
            <ul class="pagination">
              <?php
        $x = mysqli_query($con,"SELECT id FROM danhmuc");
        $tongsotin = mysqli_num_rows($x);
        $sotrang = ceil($tongsotin / $sotin1trang);
        for($t=1; $t<=$sotrang; $t++){
        echo "<li><a href='qldm.php?trang=$t'>$t</a></li>";
        }
          ?>
            </ul>
          </div>   
