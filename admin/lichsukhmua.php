      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="lichsukhmua.php" class="active"><i class="fa fa-sliders fa-fw"></i>Lịch sử</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        <div class="templatemo-top-nav-container">
          ...
          <div class="templatemo-content-widget no-padding">
            ...
            <br>
            <br>
              <div class="text-center"><h1>Lịch sử giao dịch </h1></div>
              <br>
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td class="text-center">Ngày nhận hàng</td>
                ...
                <tbody>
                  ...
                  echo '<td class="text-center">'.number_format($roww['tongtien']).'</td>';
                            ...
                            echo'<td class="text-center">Đã thanh toán</td>';
