      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
           ...
           <?php
            $nuoc="select * from thuonghieu"; 
            $connuoc= mysqli_query($con,$nuoc);
            while ($row124= mysqli_fetch_array($connuoc))
            {  
            	if($row124["id"]==1){
            		echo '<option value ="'.$row124["id"].'" selected="selected" >'.$row124["tenth"].'</option>';
            	}
            	else
			echo '<option value ="'.$row124["id"].'" >'.$row124["tenth"].'</option>';
            }
        ...
        <br>
              <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>
                  ...
                  <?php 
                  $dir="images/";
                      $sql456="select * from sanpham where idth=".$_SESSION['nuoc'];
