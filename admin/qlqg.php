      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="qlqg.php" class="active"><i class="fa fa-map-marker fa-fw"></i>Phân theo quốc gia</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
           	<br>
           	<div class="text-center"><a href="qlqg.php" class="templatemo-edit-btn">Danh sách</a>
           		<a href="pltqgo.php" class="templatemo-edit-btn">Phân theo quốc gia</a>
              <a href="themqg.php" class="templatemo-edit-btn">Thêm quốc gia</a>
              </div>
            <br>
            <br>
              <div class="text-center"><h1>Danh sách quốc gia </h1></div>
              <br>
              <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>
                  ...
                  if($from<0) $from=0;
                  $qr = "SELECT * FROM nuoc LIMIT $from, $sotin1trang";
                          ...
                          echo"<tr>";
                           ...
                           echo'<td class="text-center">' . $rownuoc["tennuoc"] .'</td>';
                             echo'<td class="text-center">' . $abc.'</td>';
                              echo'<td class="text-center"><a href="deleteqg.php?id='.$rownuoc['id'].'" class="templatemo-edit-btn">Delete</a></td>';
                            echo"</tr>";
                    }
            ...
            <ul class="pagination">
              <?php
        $x = mysqli_query($con,"SELECT id FROM nuoc");
        $tongsotin = mysqli_num_rows($x);
        $sotrang = ceil($tongsotin / $sotin1trang);
        for($t=1; $t<=$sotrang; $t++){
        echo "<li><a href='qlqg.php?trang=$t'>$t</a></li>";
        }
          ?>
            </ul>
          </div>   
