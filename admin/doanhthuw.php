      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="doanhthuw.php" class="active"><i class="fa fa-bar-chart fa-fw"></i>Theo Tuần</a></li>
        ...
        <div class="templatemo-top-nav-container">
          ...
          <div class="templatemo-content-widget no-padding">
            ...
            ?>
    			...
    			<br>
    			<br>
    			<h1 class="text-center">Doanh thu (tuần) Năm: <?php echo $row1['nam']?> Tháng: <?php echo $_SESSION['dtw']?></h1>
    			<br>
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    
                    <td class="text-center">Tuần</td>
                ...
                <tbody>
                  ...
                  $tuan[4] =0;
                      ...
                      {
                      	echo "<tr>";
                      	echo '<td  class="text-center">Tuần '.$i.'</td>';
