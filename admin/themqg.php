...
<body>
 ...
 <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            ...
            <br>
            <br>
              <div class="text-center"><h1>Thêm Quốc Gia</h1></div>
            <br>
          
            <div class="container">
        <form class="form-horizontal" action="xulythemqg.php" method="get">
        <div class="form-group">
        <label class="control-label col-sm-2" >Tên Quốc Gia:</label>
        <div class="col-sm-7">
